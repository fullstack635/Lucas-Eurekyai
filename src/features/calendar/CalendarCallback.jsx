...
/**
 * OAuth Callback Page
 * Receives redirect from Google after user authorization
 * URL: /calendar/callback?code=xxx&state=xxx
 */
const CalendarCallback = () => {
  const [searchParams] = useSearchParams();
  const navigate = useNavigate();
  const { handleOAuthCallback, isHandlingCallback, error, isSuccess } = useGoogleCalendar();
        ...
        {status === 'success' && !error && (
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">
              Tu Google Calendar ha sido conectado correctamente.
            </p>
